...
public class WishQuery {
    ...
    public static final String SELECT_WISH_BY_ID_AND_USER_ID = "SELECT * FROM wishes WHERE id = ? AND user_id = ?";
    public static final String SELECT_WISH_BY_USER_ID = "SELECT * FROM wishes WHERE user_id = ?";
}
