...
public class WishController {
    ...
    @PostMapping
    public ResponseEntity<?> createWish(@AuthUser MemberDto member, @RequestBody WishDto wishDto) {
        return new ResponseEntity<>(wishService.insertWish(wishDto, member.email()), HttpStatus.CREATED);
    }
}
