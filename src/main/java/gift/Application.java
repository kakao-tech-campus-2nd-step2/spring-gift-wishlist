...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        jdbcTemplate.execute(
            "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (1, 1, 2);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (1, 3, 1);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (2, 2, 1);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (3, 4, 3);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (4, 1, 1);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (4, 5, 2);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (5, 2, 1);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (5, 3, 1);"
            + "INSERT INTO wishlist (user_id, product_id, product_counts) VALUES (5, 4, 1)"
        );
    }
}
