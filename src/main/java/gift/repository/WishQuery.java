...
public enum WishQuery {
    ...
    UPDATE_WISH_BY_USERID_PRODUCTNAME("update wishes set count=? where user_id=?, product_name=?"),
    DELETE_WISH_BY_USERID_PRODUCTNAME("delete from wishes where user_id=?, product_name=?");
