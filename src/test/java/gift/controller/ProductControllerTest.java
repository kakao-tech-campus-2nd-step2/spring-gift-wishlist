...
public class ProductControllerTest {
    ...
    @BeforeEach
    public void setUp() {
        productDTO = new ProductResponseDTO(1L, "Test Product", 100, "test.jpg");
    }
    ...
    public void testAddProduct() throws Exception {
        when(productService.addProduct(any(ProductRequestDTO.class))).thenReturn(productDTO);
    ...
    public void testAddProductInvalidPrice() throws Exception {
        when(productService.addProduct(any(ProductRequestDTO.class))).thenThrow(new InvalidProductPriceException("가격은 0 이상으로 설정되어야 합니다."));
    ...
    public void testUpdateProductNotFound() throws Exception {
        when(productService.updateProduct(eq(1L), any(ProductRequestDTO.class))).thenThrow(new ProductNotFoundException("상품을 다음의 id로 찾을 수 없습니다. id: 1"));
